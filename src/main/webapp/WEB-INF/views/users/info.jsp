			...
			<div class="col-md-7 col-lg-4 mt-4">
				...
				<!-- input 요소 -->
					...
					<div class="input-group mt-3 mb-4">
						...
						<input class="form-control" id="email" type="email" name="email" value="${dto.email}" required disabled/>
...
<%-- 					<div class="input-group mt-3 mb-3">
					...
					<div class="input-group mb-5">
						...
						<input class="form-control" id="name" type="text" name="name" value="${dto.name}" required disabled/>
