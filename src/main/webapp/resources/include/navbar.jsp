    		...
    		<div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
	      		<ul class="navbar-nav" style="border: 1px solid #DCDCDC; height: 79px;">
	        		<li class="nav-item dropdown"  style="border-left: 1px solid #DCDCDC;">
	        			<a class="nav-link dropdown-toggle" style="padding: 32px 0px; border-left: 0px solid #DCDCDC; height: 79px; width: 70px; margin: 0px 30px"
	        				href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"
	        				onMouseOver="this.innerHTML='<strong>지수테이</strong>'" onMouseOut="this.innerHTML='<strong>ABOUT</strong>'">
	        				<strong>ABOUT</strong>
	        			</a>
	        		...
	        		<li class="nav-item dropdown" style="border-left: 1px solid #DCDCDC;">
			        	<a class="nav-link dropdown-toggle" style=" padding: 32px 0px; width: 80px;height: 79px;margin: 0px 30px"	 
				        	 href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"
			        ...
			        <li class="nav-item"  style="border-left: 1px solid #DCDCDC;">
			          <a class="nav-link" style="padding: 32px 0px;width: 80px;height: 79px;margin: 0px 30px"
				           	 href="${pageContext.request.contextPath }/travel/list.do" onMouseOver="this.innerHTML='<strong>주변 여행지</strong>'"
				           	 onMouseOut="this.innerHTML='<strong>TRAVEL</strong>'" >
				           	 <strong>TRAVEL</strong></a>
			        </li>

			        <li class="nav-item"  style="border-left: 1px solid #DCDCDC;">
			          <a class="nav-link" style="padding: 32px 0px;width: 120px;height: 79px;margin: 0px 30px"
				           href="${pageContext.request.contextPath }/reservation/list.do" onMouseOver="this.innerHTML='<strong>실시간예약</strong>'"
				           onMouseOut="this.innerHTML='<strong>RESERVATION</strong>'">
				           <strong>RESERVATION</strong></a>
			        </li>

			 		<li class="nav-item"  style="border-left: 1px solid #DCDCDC;">
			          <a class="nav-link" style="padding: 32px 0px;border-left: 0px solid #DCDCDC;width: 100px;height: 79px;margin: 0px 30px;"
				           href="${pageContext.request.contextPath }/notice/list.do" onMouseOver="this.innerHTML='<strong>커뮤니티</strong>'"
				           onMouseOut="this.innerHTML='<strong>COMMUNITY</strong>'">
				           <strong>COMMUNITY</strong></a>
			        </li>
	       		</ul> 
