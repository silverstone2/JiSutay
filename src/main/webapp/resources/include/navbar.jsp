...
<body>
	...
	<hgroup>
		...
		<ul>
			...
			<li class="gb"><a href="#"><span class="en">TRAVEL</span><span class="ko">주변여행지</span></a></li>
			<li class="gb">
				<a href="#">
			...
			<li class="gb"><a href="#"><span class="en">COMMUNITY</span><span class="ko">커뮤니티</span></a></li>
		...
		<c:otherwise>
			...
			<div class="container-fluid">
				...
				<a class="nav-bar-brand" href="${pageContext.request.contextPath }/">로그아웃</a>		       
 			</div>
